...
SRC_npdm = modules/npdm/npdm.C modules/npdm/npdm_driver.C modules/npdm/npdm_patterns.C modules/npdm/npdm_expectations.C modules/npdm/npdm_expectations_engine.C  \
           ...
           modules/npdm/onepdm_container.C modules/npdm/twopdm_container.C modules/npdm/threepdm_container.C \
           modules/two_index_ops/two_index_wrappers.C modules/three_index_ops/three_index_wrappers.C \
           modules/three_index_ops/three_index_compound_ops.C modules/three_index_ops/three_index_op_components.C  modules/npdm/pairpdm_container.C \
           modules/three_index_ops/three_index_ops.C modules/three_index_ops/build_3index_ops.C \
           modules/npdm/fourpdm_container.C  modules/four_index_ops/four_index_ops.C   modules/four_index_ops/four_index_op_components.C modules/four_index_ops/build_4index_ops.C \
					 modules/four_index_ops/four_index_compound_ops.C  modules/four_index_ops/four_index_wrappers.C  \
...
SRC_spin_adapted = wrapper.C fciqmchelper.C saveBlock.C Stackspinblock.C operatorUtilities.C Stack_op_components.C stackguess_wavefunction.C Stackwavefunction.C Stackdensity.C stackopxop.C StackBaseOperator.C StackOperators.C modules/ResponseTheory/sweepResponse.C modules/ResponseTheory/sweepCompress.C pario.C dmrg.C fiedler.C least_squares.C sweep_mps.C set_stackspinblock_components.C linear.C main.C readinput.C  timer.C SpinQuantum.C Symmetry.C input.C hfOccGenerator.C Schedule.C orbstring.C slater.C csf.C StateInfo.C  screen.C MatrixBLAS.C operatorfunctions.C solver.C davidson.C sweep_params.C sweep.C partial_sweep.C BlockAndDecimate.C initblocks.C rotationmat.C renormalise.C couplingCoeffs.C distribute.C new_anglib.C fci.C IrrepSpace.C modules/generate_blocks/sweep.C $(SRC_genetic) SpinSpace.C include/IntegralMatrix.C modules/onepdm/sweep.C modules/onepdm/onepdm.C $(SRC_npdm) $(SRC_mps_nevpt) #modules/twopdm/sweep.C modules/twopdm/twopdm.C modules/twopdm/twopdm_2.C
